...
class seqCNN(object):
    ...
    def __init__(self,num_classes, num_filters, num_pooled, vocabulary_length, region_size, max_sentence_length, l2_reg_lambda=0.0):
        ...
        self.probs = tf.nn.softmax(scores,name="probs")
