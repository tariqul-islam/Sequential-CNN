...
import data_helpers_imdb as dhrt

import os
import time
import datetime

from seq_cnn_old import seqCNN
from seq_cnn_old import seq_pre_processor

#load data
x_rt, y_rt = dhrt.load_data_and_labels()
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        #reload graph with existing data
